...
'm=ChestClinic;d=ChestClinic;t=TbOrCa;p=sfl;r=uniform;s=naive;b=100;k=10.csv' every 1 using 1:3 lt 3 lc 3 pt 3 lw 4title 'SFL(naive)' with linespoints, \
'm=ChestClinic;d=ChestClinic;t=TbOrCa;p=sfl;r=uniform;s=normal;b=100;k=10.csv' every 1 using 1:3 lt 4 lc 4 pt 4 lw 4title 'SFL(Bayesian)' with linespoints;
EOF
