...
set title 'ChestClinic (grsfl)';
set output 'chestclinic-grsfl-compare.ps';
plot 'm=ChestClinic;d=ChestClinic;t=TbOrCa;p=MBgrsfl;r=uniform;s=normal;b=100;k=10.csv' every 1 using 1:3 lt 1 lc 1 pt 1 lw 4 title 'MBgrsfl(Bayesian)' with linespoints, \
'm=ChestClinic;d=ChestClinic;t=TbOrCa;p=grsfl;r=uniform;s=normal;b=100;k=10.csv' every 1 using 1:3 lt 2 lc 2 pt 2 lw 4 title 'grsfl(Bayesian)' with linespoints, \
'm=ChestClinic;d=ChestClinic;t=TbOrCa;p=grsfl;r=uniform;s=naive;b=100;k=10.csv' every 1 using 1:3 lt 3 lc 3 pt 3 lw 4 title 'grsfl(na{\357}ve)' with linespoints, \
