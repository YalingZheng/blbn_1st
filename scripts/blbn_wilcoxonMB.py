...
_policies1 = ["random", "rr", "br", "empg", "dsep", "dsepw1", "dsepw2", "rsfl"];
_policies2 = ["MBrandom", "MBrr", "MBbr", "MBempg", "MBdsep", "MBdsepw1", "MBdsepw2", "MBrsfl"];
...
def readthebudget(policy, network, dataset, target, structure, budget):
    ...
    for iter in range(10):
        ...
        if ((policy=="rsfl") and (not os.path.isfile(curfilename))):
            policy = "sfl"
            curfilename = "m="+network+";d="+dataset+";t="+target+";p="+policy+";r=uniform;s="+structure+";b=100;k=10/*/graph.csv."+str(iter);
        if ((policy=="MBrsfl") and (not os.path.isfile(curfilename))):
            policy = "MBsfl"
            curfilename = "m="+network+";d="+dataset+";t="+target+";p="+policy+";r=uniform;s="+structure+";b=100;k=10/*/graph.csv."+str(iter);
