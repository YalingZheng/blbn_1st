...
set output 'chestclinic-rsfl.ps';
...
'm=ChestClinic;d=ChestClinic;t=TbOrCa;p=rsfl;r=uniform;s=naive;b=100;k=10.csv' every 1 using 1:3 lt 3 lc 3 pt 3 lw 4title 'RSFL(naive)' with linespoints, \
'm=ChestClinic;d=ChestClinic;t=TbOrCa;p=rsfl;r=uniform;s=normal;b=100;k=10.csv' every 1 using 1:3 lt 4 lc 4 pt 4 lw 4title 'RSFL(Bayesian)' with linespoints;
EOF
