...
set title 'ALARM (dsepw2)';
set output 'alarm-dsepw2-compare.ps';
plot 'm=ALARM;d=ALARM;t=Press;p=MBdsepw2;r=uniform;s=normal;b=100;k=10.csv' every 1 using 1:3 lt 1 lc 1 pt 1 lw 4 title 'MBdsepw2(Bayesian)' with linespoints, \
...
'm=ALARM;d=ALARM;t=Press;p=dsepw2;r=uniform;s=naive;b=100;k=10.csv' every 1 using 1:3 lt 3 lc 3 pt 3 lw 4 title 'dsepw2(na{\357}ve)' with linespoints, \
