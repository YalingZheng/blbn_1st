...
set title 'CarDiagnosis2 (dsepw1)';
set output 'cardiagnosis2-dsepw1-compare.ps';
plot 'm=CarDiagnosis2;d=CarDiagnosis2;t=ST;p=MBdsepw1;r=uniform;s=normal;b=100;k=10.csv' every 1 using 1:3 lt 1 lc 1 pt 1 lw 4 title 'MBdsepw1(Bayesian)' with linespoints, \
'm=CarDiagnosis2;d=CarDiagnosis2;t=ST;p=dsepw1;r=uniform;s=normal;b=100;k=10.csv' every 1 using 1:3 lt 2 lc 2 pt 2 lw 4 title 'dsepw1(Bayesian)' with linespoints, \
