...
set title 'Animals (gsfl)';
set output 'animals-gsfl-compare.ps';
plot 'm=Animals;d=Animals;t=Animal;p=MBgsfl;r=uniform;s=normal;b=100;k=10.csv' every 1 using 1:3 lt 1 lc 1 pt 1 lw 4 title 'MBgsfl(Bayesian)' with linespoints, \
'm=Animals;d=Animals;t=Animal;p=gsfl;r=uniform;s=normal;b=100;k=10.csv' every 1 using 1:3 lt 2 lc 2 pt 2 lw 4 title 'gsfl(Bayesian)' with linespoints, \
'm=Animals;d=Animals;t=Animal;p=gsfl;r=uniform;s=naive;b=100;k=10.csv' every 1 using 1:3 lt 3 lc 3 pt 3 lw 4 title 'gsfl(na{\357}ve)' with linespoints, \
