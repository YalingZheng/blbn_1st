...
'm=Animals;d=Animals;t=Animal;p=br;r=uniform;s=naive;b=100;k=10.csv' every 1 using 1:3 lt 3 lc 3 pt 3 lw 4 title 'br(naive)' with linespoints, \
...
'm=Animals;d=Animals;t=Animal;p=bl;r=uniform;s=naive;b=100;k=10.csv' every 1 using 1:3 lt 5 lc 5 pt 5 lw 4 title 'Baseline(naive)' with linespoints;
EOF
