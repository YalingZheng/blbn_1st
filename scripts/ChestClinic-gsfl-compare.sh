...
set title 'ChestClinic (gsfl)';
set output 'chestclinic-gsfl-compare.ps';
plot 'm=ChestClinic;d=ChestClinic;t=TbOrCa;p=MBgsfl;r=uniform;s=normal;b=100;k=10.csv' every 1 using 1:3 lt 1 lc 1 pt 1 lw 4 title 'MBgsfl(Bayesian)' with linespoints, \
'm=ChestClinic;d=ChestClinic;t=TbOrCa;p=gsfl;r=uniform;s=normal;b=100;k=10.csv' every 1 using 1:3 lt 2 lc 2 pt 2 lw 4 title 'gsfl(Bayesian)' with linespoints, \
'm=ChestClinic;d=ChestClinic;t=TbOrCa;p=gsfl;r=uniform;s=naive;b=100;k=10.csv' every 1 using 1:3 lt 3 lc 3 pt 3 lw 4 title 'gsfl(na{\357}ve)' with linespoints, \
