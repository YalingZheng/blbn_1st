...
set title 'Animals (dsepw1)';
set output 'animals-dsepw1-compare.ps';
plot 'm=Animals;d=Animals;t=Animal;p=MBdsepw1;r=uniform;s=normal;b=100;k=10.csv' every 1 using 1:3 lt 1 lc 1 pt 1 lw 4 title 'MBdsepw1(Bayesian)' with linespoints, \
'm=Animals;d=Animals;t=Animal;p=dsepw1;r=uniform;s=normal;b=100;k=10.csv' every 1 using 1:3 lt 2 lc 2 pt 2 lw 4 title 'dsepw1(Bayesian)' with linespoints, \
