...
set title 'CarDiagnosis2 (rr)';
set output 'cardiagnosis2-rr-compare.ps';
plot 'm=CarDiagnosis2;d=CarDiagnosis2;t=ST;p=MBrr;r=uniform;s=normal;b=100;k=10.csv' every 1 using 1:3 lt 1 lc 1 pt 1 lw 4 title 'MBrr(Bayesian)' with linespoints, \
'm=CarDiagnosis2;d=CarDiagnosis2;t=ST;p=rr;r=uniform;s=normal;b=100;k=10.csv' every 1 using 1:3 lt 2 lc 2 pt 2 lw 4 title 'rr(Bayesian)' with linespoints, \
'm=CarDiagnosis2;d=CarDiagnosis2;t=ST;p=rr;r=uniform;s=naive;b=100;k=10.csv' every 1 using 1:3 lt 3 lc 3 pt 3 lw 4 title 'rr(na{\357}ve)' with linespoints, \
