...
set title 'Animals (dsepw2)';
set output 'animals-dsepw2-compare.ps';
plot 'm=Animals;d=Animals;t=Animal;p=MBdsepw2;r=uniform;s=normal;b=100;k=10.csv' every 1 using 1:3 lt 1 lc 1 pt 1 lw 4 title 'MBdsepw2(Bayesian)' with linespoints, \
...
'm=Animals;d=Animals;t=Animal;p=dsepw2;r=uniform;s=naive;b=100;k=10.csv' every 1 using 1:3 lt 3 lc 3 pt 3 lw 4 title 'dsepw2(na{\357}ve)' with linespoints, \
'm=Animals;d=Animals;t=Animal;p=bl;r=uniform;s=normal;b=100;k=10.csv' every 1 using 1:3 lt 4 lc 4 pt 4 lw 4 title 'Baseline(Bayesian)' with linespoints, \
'm=Animals;d=Animals;t=Animal;p=bl;r=uniform;s=naive;b=100;k=10.csv' every 1 using 1:3 lt 5 lc 5 pt 5 lw 4 title 'Baseline(na{\357}ve)' with linespoints;
EOF
