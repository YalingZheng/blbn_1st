...
set title 'Poya\_Ganga (dsep)';
set output 'poya-dsep-compare.ps';
plot 'm=Poya_Ganga;d=Poya_m=Poya_Ganga;d=Poya_Ganga;t=G4;p=MBdsep;r=uniform;s=normal;b=100;k=10.csv' every 1 using 1:3 lt 1 lc 1 pt 1 lw 4 title 'MBdsep(Bayesian)' with linespoints, \
'm=Poya_Ganga;d=Poya_m=Poya_Ganga;d=Poya_Ganga;t=G4;p=dsep;r=uniform;s=normal;b=100;k=10.csv' every 1 using 1:3 lt 2 lc 2 pt 2 lw 4 title 'dsep(Bayesian)' with linespoints, \
'm=Poya_Ganga;d=Poya_m=Poya_Ganga;d=Poya_Ganga;t=G4;p=dsep;r=uniform;s=naive;b=100;k=10.csv' every 1 using 1:3 lt 3 lc 3 pt 3 lw 4 title 'dsep(na{\357}ve)' with linespoints, \
