...
set title 'CarDiagnosis2 (sfl)';
set output 'cardiagnosis2-sfl-compare.ps';
plot 'm=CarDiagnosis2;d=CarDiagnosis2;t=ST;p=MBsfl;r=uniform;s=normal;b=100;k=10.csv' every 1 using 1:3 lt 1 lc 1 pt 1 lw 4 title 'MBsfl(Bayesian)' with linespoints, \
'm=CarDiagnosis2;d=CarDiagnosis2;t=ST;p=sfl;r=uniform;s=normal;b=100;k=10.csv' every 1 using 1:3 lt 2 lc 2 pt 2 lw 4 title 'sfl(Bayesian)' with linespoints, \
'm=CarDiagnosis2;d=CarDiagnosis2;t=ST;p=sfl;r=uniform;s=naive;b=100;k=10.csv' every 1 using 1:3 lt 3 lc 3 pt 3 lw 4 title 'sfl(na{\357}ve)' with linespoints, \
