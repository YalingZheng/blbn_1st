...
set title 'Animals (rr)';
set output 'animals-rr-compare.ps';
plot 'm=Animals;d=Animals;t=Animal;p=MBrr;r=uniform;s=normal;b=100;k=10.csv' every 1 using 1:3 lt 1 lc 1 pt 1 lw 4 title 'MBrr(Bayesian)' with linespoints, \
'm=Animals;d=Animals;t=Animal;p=rr;r=uniform;s=normal;b=100;k=10.csv' every 1 using 1:3 lt 2 lc 2 pt 2 lw 4 title 'rr(Bayesian)' with linespoints, \
'm=Animals;d=Animals;t=Animal;p=rr;r=uniform;s=naive;b=100;k=10.csv' every 1 using 1:3 lt 3 lc 3 pt 3 lw 4 title 'rr(na{\357}ve)' with linespoints, \
