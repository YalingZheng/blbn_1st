...
set title 'ChestClinic (rsfl)';
set output 'chestclinic-rsfl-compare.ps';
plot 'm=ChestClinic;d=ChestClinic;t=TbOrCa;p=MBrsfl;r=uniform;s=normal;b=100;k=10.csv' every 1 using 1:3 lt 1 lc 1 pt 1 lw 4 title 'MBrsfl(Bayesian)' with linespoints, \
'm=ChestClinic;d=ChestClinic;t=TbOrCa;p=rsfl;r=uniform;s=normal;b=100;k=10.csv' every 1 using 1:3 lt 2 lc 2 pt 2 lw 4 title 'rsfl(Bayesian)' with linespoints, \
'm=ChestClinic;d=ChestClinic;t=TbOrCa;p=rsfl;r=uniform;s=naive;b=100;k=10.csv' every 1 using 1:3 lt 3 lc 3 pt 3 lw 4 title 'rsfl(na{\357}ve)' with linespoints, \
